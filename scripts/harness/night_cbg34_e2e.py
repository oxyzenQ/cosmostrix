...
Usage (repo root, release binary built):
  ...
  python3 scripts/harness/night_cbg34_e2e.py              # all scenarios
  python3 scripts/harness/night_cbg34_e2e.py S1 S3        # subset
  BIN=/path/to/cosmostrix python3 scripts/harness/night_cbg34_e2e.py
