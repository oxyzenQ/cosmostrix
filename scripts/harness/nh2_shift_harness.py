...
Usage (repo root, release binary built):
  ...
  python3 scripts/harness/nh2_shift_harness.py                     # 75 s, no keys
  KEYS_AT=70: python3 scripts/harness/nh2_shift_harness.py         # 's' at t=70
  KEYS_AT=70: SCENE=monolith: python3 scripts/harness/nh2_shift_harness.py
  KEYS_AT=50,65,80: python3 scripts/harness/nh2_shift_harness.py   # s, c, s
