...
#
# USAGE:
#   ./scripts/harness/apply-visual-preset.sh <preset>   # apply a preset
#   ./scripts/harness/apply-visual-preset.sh show       # detect the active preset
#   ./scripts/harness/apply-visual-preset.sh list       # list available presets
#
...
def main():
    ...
    print("Revert to champion: ./scripts/harness/apply-visual-preset.sh cinema-noir")
