...
#
#   ./scripts/release/bump-rust-to.sh 1.98.1
#
...
#
# This script is a thin forwarder: scripts/release/rust-version-to.sh is the
...
#
#   ./scripts/release/bump-rust-to.sh 1.99.0            bump to 1.99.0
#   ./scripts/release/bump-rust-to.sh --check 1.98.1     verify everything is at 1.98.1
#   ./scripts/release/bump-rust-to.sh --allow-dirty 1.99.0   bump on a dirty tree
#   ./scripts/release/bump-rust-to.sh --help             full usage from the implementation
#
# See scripts/release/rust-version-to.sh for the contract and
# docs/workflow/ABOUT_CI.md for the versioning policy.

set -euo pipefail

REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
readonly TARGET="${REPO_ROOT}/scripts/release/rust-version-to.sh"
