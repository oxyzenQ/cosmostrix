...
# NIGHT-refactor-1: scripts live in category subdirectories now, so the
# repository root is two levels up from this file (scripts/bench/).
REPO_ROOT = SCRIPT_DIR.parents[1]
OUTPUT_DIR = REPO_ROOT / "benchmark"
