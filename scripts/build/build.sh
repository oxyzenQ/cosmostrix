...
# LOC_EXEMPT: single-entry orchestrator (dispatch + build/check/pgo/miri/version-sync commands); a split is a standalone risk-balanced task, tracked as migration debt by scripts/gates/check-scripts-loc.sh (NIGHT-lts-1).
#
# ─────────────────────────────────────────────────────────────────────────────
