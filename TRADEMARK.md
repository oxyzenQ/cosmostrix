...
- Forking the source code under the terms of GPL-3.0-only, provided the
  fork is clearly renamed and does NOT use the cosmostrix Marks.
...
Forks of cosmostrix MUST:

- Use a different project name.
- Use different branding (logo, color scheme, etc.).
- Preserve the GPL-3.0-only license and copyright notice.
- Clearly state that the fork is derived from cosmostrix but is NOT
  cosmostrix and is NOT endorsed by rezky_nightky (oxyzenQ).
