...
┌──────────────────────────────────────────────────────────────────────────────┐
│  2. STATE UPDATE                                                            │
│  src/engine/cosmic_dragon_engine/cloud/mod.rs:441-465  (Cloud::set_mouse_click)                         │
│  ────────────────────────────────────────────                               │
...
│                                                                              │
│  src/engine/cosmic_dragon_engine/cloud/spawn.rs:740-789  (Cloud::spawn_quantum_ripple)                 │
│  ──────────────────────────────────────────────                             │
...
│  src/engine/cosmic_dragon_engine/cloud/rain.rs:583-595                                                  │
│  ─────────────────────                                                      │
...
│  src/engine/cosmic_dragon_engine/cloud/rain.rs:732 + 1082-1218  (Cloud::apply_quantum_ripple)          │
│  ─────────────────────────────────────────────────────────────────────      │
...
│  src/engine/cosmic_dragon_engine/cloud/rain.rs:939-945                                                  │
│  ─────────────────────                                                      │
...
| `src/engine/cosmic_dragon_engine/cloud/mod.rs:436-465` | `set_mouse_position` + `set_mouse_click` (pool slot selection, eviction) |
| `src/engine/cosmic_dragon_engine/cloud/mod.rs:613-618` | Pause-time birth shift for flash waves |
| `src/engine/cosmic_dragon_engine/cloud/spawn.rs:740-789` | `spawn_quantum_ripple` (particle pool fill) |
| `src/engine/cosmic_dragon_engine/cloud/render.rs:27-54` | `FlashWaveCtx` (precomputed view) + `FlashWave` (runtime slot) types |
| `src/engine/cosmic_dragon_engine/cloud/render.rs:115` | `DrawCtx::flash_waves: &[FlashWaveCtx]` field |
| `src/engine/cosmic_dragon_engine/cloud/rain.rs:583-595` | Per-frame precompute of active flash waves into `SmallVec` |
| `src/engine/cosmic_dragon_engine/cloud/rain.rs:732` | Call to `apply_quantum_ripple` |
| `src/engine/cosmic_dragon_engine/cloud/rain.rs:939-945` | Per-frame expiry sweep |
| `src/engine/cosmic_dragon_engine/cloud/rain.rs:1082-1218` | `apply_quantum_ripple` (particle update + render) |
...
| `src/engine/cosmic_dragon_engine/cloud/tests/tests_quantum.rs:645-768` | fix regression tests |
...
### 2.2 `src/engine/cosmic_dragon_engine/cloud/mod.rs` — Click State Update
...
### 2.3 `src/engine/cosmic_dragon_engine/cloud/spawn.rs` — Quantum Ripple Spawner
...
### 2.4 `src/engine/cosmic_dragon_engine/cloud/render.rs` — DrawCtx & FlashWaveCtx Types
...
### 2.5 `src/engine/cosmic_dragon_engine/cloud/rain.rs` — Per-Frame Precompute + Expiry Sweep
...
### 2.7 `src/engine/cosmic_dragon_engine/cloud/mod.rs:613-618` — Pause Birth Shift
...
### 2.8 `src/engine/cosmic_dragon_engine/cloud/spawn.rs:25-153` — `reset()` Does Not Clear Mouse State
...
**Location:** `src/engine/cosmic_dragon_engine/cloud/rain.rs:586`
...
**Location:** `src/engine/cosmic_dragon_engine/cloud/mod.rs:445, 447` + `src/engine/cosmic_dragon_engine/cloud/spawn.rs:743`
...
**Location:** `src/engine/cosmic_dragon_engine/cloud/mod.rs:toggle_pause` BRANCH 2 (lines 562-625)
...
**Location:** `src/engine/cosmic_dragon_engine/cloud/spawn.rs:25-153`
...
**Location:** `src/engine/cosmic_dragon_engine/cloud/mod.rs:447`
...
**File:** `src/engine/cosmic_dragon_engine/cloud/render.rs:33-41` + `src/engine/cosmic_dragon_engine/cloud/rain.rs:583-595` + `src/droplet.rs:769-816`
...
**File:** `src/engine/cosmic_dragon_engine/cloud/mod.rs:613-618`
