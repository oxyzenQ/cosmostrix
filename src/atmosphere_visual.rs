...
// atmosphere_tests/* but not yet wired into the production render path.
// (v30: the now-deleted `atmosphere_ab.rs` test module was previously
// also a consumer; see docs/archive/audits/ATMOSPHERE_SUBSYSTEM_ARCHIVAL.md.)
// Silence dead_code in release builds; tests still verify full coverage.
