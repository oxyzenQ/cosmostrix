...
mod tests {
    ...
    // ── P2 + P4 tests migrated to ───────────────────────────────────────────
    //    src/central_control_dragon_power/reclaim_state.rs
    // (5 tests moved: 3 resync_interval + 2 reclaim_state.)

    // ── P5 tests migrated to ────────────────────────────────────────────────
    //    src/central_control_dragon_power/endurance_health.rs
    // (5 tests moved: 1 cross-platform + 4 Linux-only RSS/jitter/ctxt.)
