...
/// (2026-09-13, owner mandate): maximum number of custom palette
/// blocks accepted in a single config.toml. Aligned with charset-custom,
...
/// iteration cost in `collect_colors_custom`; 24 blocks is far beyond
/// any realistic use case (built-in themes are ~44).
pub(crate) const COLORS_CUSTOM_MAX_BLOCKS: usize = 24;
...
///
/// v50.0.0-beta.6 LTS, NIGHT-hunt-39, NIGHT-hunt-40: bounded by
/// `COLORS_CUSTOM_MAX_BLOCKS` (24) and `COLORS_CUSTOM_MAX_RAIN_STOPS`
