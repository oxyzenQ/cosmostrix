    ...
    match key {
        ...
        "msg-fill-style" => {
            ...
            match lower.as_str() {
                ...
                | "engrave" | "hologram" | "glitch" | "scorch" | "cascade" | "radar" => None,
                _ => Some(format!(
                    "expected typewriter/fade/words/slide/instant/engrave/hologram/glitch/scorch/cascade/radar, got '{v}' (run `cosmostrix --help` for valid message fill styles)"
                )),
            }
        }
