    ...
    match key {
        ...
        "msg-fill-style" => {
            ...
            match lower.as_str() {
                ...
                | "engrave" | "hologram" | "glitch" => None,
                _ => Some(format!(
                    "expected typewriter/fade/words/slide/pulse/instant/engrave/hologram/glitch, got '{v}' (run `cosmostrix --help` for valid message fill styles)"
                )),
            }
        }
