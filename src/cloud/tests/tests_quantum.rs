...
use crate::constants::{
    ...
    QUANTUM_BRAND_PURPLE_G, QUANTUM_BRAND_PURPLE_R, QUANTUM_RIPPLE_BOUNCE_DAMPING,
    QUANTUM_RIPPLE_HEAD_END_FRAC, QUANTUM_RIPPLE_LIFETIME_SECS, QUANTUM_RIPPLE_PARTICLE_COUNT,
    QUANTUM_RIPPLE_POOL_SIZE, QUANTUM_RIPPLE_SPEED, QUANTUM_RIPPLE_TAIL_START_FRAC,
};
