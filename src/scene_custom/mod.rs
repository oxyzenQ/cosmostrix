...
//! rain = "lorenz"               # NIGHT-research-5: pick rain style (glyph/monolith/vortex/flux/lorenz/dragon/physarum/black_hole/aeolian/aurora)
...
//! monolith, vortex, flux, lorenz, dragon, physarum, black_hole, aeolian, aurora) — previously
...
/// lorenz/dragon/physarum/black_hole/aeolian/aurora).
...
/// monolith, vortex, flux, lorenz, dragon, physarum, black_hole, aeolian, aurora). It leads the error-message order so a
...
pub(crate) struct UserProfile {
    ...
    /// vortex, flux, lorenz, dragon, physarum, black_hole, aeolian, aurora). Parsed by
