...
The v50 era: the v50.0.0 pre-release line (beta.6 down to alpha.1)
plus the condensed v25.0.0, v20.x, v15.0.0, v14.0.0, and v13.x release
summaries — the three-dragon-engines era. These sections were moved
here unchanged from the live [CHANGELOG.md](CHANGELOG.md) in
NIGHT-docs-1 — immutable historical record, original order preserved.
