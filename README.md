...
v2.2.0 throughput exceeds 7,000 FPS headless (120×40, well above the 60 FPS
...
Cosmostrix uses SemVer for package versions, e.g. `2.2.0`.
Git tags and GitHub Releases use a leading `v`, e.g. `v2.2.0`.
