...
- [Benchmarking Guide](docs/BENCHMARKING.md) — full independent benchmarking guide: how to run, interpret, compare, strict `--bench-scene` validation, v50 4-scene reference matrix (84,815 avg_fps monolith / 26,252 avg_fps cinematic on 2-vCPU cloud Xeon)
