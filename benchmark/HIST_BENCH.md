...
see [Atmosphere Engine](../docs/archive/specs/ATMOSPHERE_ENGINE.md) and
...
- `scaling_results.{json,md}` - per-size scaling sweep from `scripts/bench/run_scaling_benchmarks.py`
